import { Alert, Descriptions, Form, InputNumber, List, Typography, message } from 'antd'
import { Button, Card, Input, Segmented, Select, Space, Switch, Tabs, Tag } from '../../components/ui'
