...
export interface ReadingActivity { url:string; title:string; firstVisitedAt:number; lastVisitedAt:number; activeSeconds:number; maxScrollDepth:number; visitCount:number }
