...
export function DocumentDetailDrawer({ document, onClose, onDeleted, onExported }: { document: Document|null; onClose:()=>void; onDeleted:(id:string)=>void; onExported?: (document: Document) => void }) {
